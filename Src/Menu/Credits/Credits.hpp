...
#ifndef BOMBERMAN_credits_H
#define BOMBERMAN_credits_H
...
namespace ind {
    ...
    /**
     * @brief A class which contains the credits of the game.
     */
    ...
    public:
        ...
        Credits(Core &core, irr::IrrlichtDevice *device, irr::video::IVideoDriver *driver);
    ...
    private:
        ...
        irr::scene::ISceneManager *_creditsSceneManager;
